...
${CMAKE_CURRENT_LIST_DIR}/LPC54628
...
include_if_use(BOARD_Project_Template_lpcxpresso54628)
...
include_if_use(DEVICES_Project_Template_LPC54628.LPC54628)
include_if_use(RTE_Device.LPC54628)
include_if_use(component_audio_flexcomm_i2s_dma_adapter.LPC54628)
include_if_use(component_button.LPC54628)
include_if_use(component_codec_adapters.LPC54628)
include_if_use(component_codec_i2c.LPC54628)
include_if_use(component_common_task)
include_if_use(component_cs42888_adapter.LPC54628)
include_if_use(component_ctimer_adapter.LPC54628)
include_if_use(component_da7212_adapter.LPC54628)
include_if_use(component_flexcomm_i2c_adapter.LPC54628)
include_if_use(component_flexcomm_spi_adapter.LPC54628)
include_if_use(component_gint_adapter.LPC54628)
include_if_use(component_led.LPC54628)
include_if_use(component_lists.LPC54628)
include_if_use(component_log.LPC54628)
include_if_use(component_log_backend_debugconsole.LPC54628)
include_if_use(component_log_backend_debugconsole_lite.LPC54628)
include_if_use(component_log_backend_ringbuffer.LPC54628)
include_if_use(component_lpc_crc_adapter.LPC54628)
include_if_use(component_lpc_gpio_adapter.LPC54628)
include_if_use(component_lpcrtc.LPC54628)
include_if_use(component_mem_manager.LPC54628)
include_if_use(component_mem_manager_freertos.LPC54628)
include_if_use(component_mem_manager_light.LPC54628)
include_if_use(component_mflash_common.LPC54628)
include_if_use(component_mflash_dummy.LPC54628)
include_if_use(component_mflash_file.LPC54628)
include_if_use(component_mflash_lpc54xxx.LPC54628)
include_if_use(component_mrt_adapter.LPC54628)
...
include_if_use(component_panic.LPC54628)
include_if_use(component_pwm_ctimer_adapter.LPC54628)
include_if_use(component_reset_adapter.LPC54628)
include_if_use(component_rng_adapter.LPC54628)
include_if_use(component_serial_manager.LPC54628)
include_if_use(component_serial_manager_spi.LPC54628)
include_if_use(component_serial_manager_swo.LPC54628)
include_if_use(component_serial_manager_uart.LPC54628)
include_if_use(component_serial_manager_usb_cdc.LPC54628)
include_if_use(component_serial_manager_virtual.LPC54628)
include_if_use(component_serial_mwm)
include_if_use(component_serial_mwm_port)
include_if_use(component_serial_mwm_usart)
include_if_use(component_sgtl_adapter.LPC54628)
include_if_use(component_silicon_id.LPC54628)
include_if_use(component_software_crc_adapter.LPC54628)
include_if_use(component_software_rng_adapter.LPC54628)
include_if_use(component_timer_manager.LPC54628)
include_if_use(component_usart_adapter.LPC54628)
include_if_use(component_usart_dma_adapter.LPC54628)
include_if_use(component_wm8904_adapter.LPC54628)
include_if_use(component_wm8960_adapter.LPC54628)
include_if_use(device_LPC54628_CMSIS.LPC54628)
include_if_use(device_LPC54628_startup.LPC54628)
include_if_use(device_LPC54628_system.LPC54628)
include_if_use(driver_clock.LPC54628)
include_if_use(driver_cmsis_flexcomm_i2c.LPC54628)
include_if_use(driver_cmsis_flexcomm_spi.LPC54628)
include_if_use(driver_cmsis_flexcomm_usart.LPC54628)
include_if_use(driver_codec.LPC54628)
include_if_use(driver_common.LPC54628)
include_if_use(driver_cs42888.LPC54628)
include_if_use(driver_ctimer.LPC54628)
include_if_use(driver_dialog7212.LPC54628)
include_if_use(driver_dmic.LPC54628)
include_if_use(driver_dmic_dma.LPC54628)
include_if_use(driver_dmic_hwvad.LPC54628)
include_if_use(driver_eeprom.LPC54628)
include_if_use(driver_emc.LPC54628)
include_if_use(driver_flashiap.LPC54628)
include_if_use(driver_flexcomm.LPC54628)
include_if_use(driver_flexcomm_i2c.LPC54628)
include_if_use(driver_flexcomm_i2c_dma.LPC54628)
include_if_use(driver_flexcomm_i2c_freertos.LPC54628)
include_if_use(driver_flexcomm_i2s.LPC54628)
include_if_use(driver_flexcomm_i2s_dma.LPC54628)
include_if_use(driver_flexcomm_spi.LPC54628)
include_if_use(driver_flexcomm_spi_dma.LPC54628)
include_if_use(driver_flexcomm_spi_freertos.LPC54628)
include_if_use(driver_flexcomm_usart.LPC54628)
include_if_use(driver_flexcomm_usart_dma.LPC54628)
include_if_use(driver_flexcomm_usart_freertos.LPC54628)
include_if_use(driver_fmc.LPC54628)
include_if_use(driver_fmeas.LPC54628)
include_if_use(driver_fro_calib.LPC54628)
include_if_use(driver_ft5406.LPC54628)
include_if_use(driver_ft6x06.LPC54628)
include_if_use(driver_fxos8700cq.LPC54628)
include_if_use(driver_gint.LPC54628)
include_if_use(driver_gt911.LPC54628)
include_if_use(driver_iap.LPC54628)
include_if_use(driver_ili9341.LPC54628)
include_if_use(driver_inputmux.LPC54628)
include_if_use(driver_inputmux_connections.LPC54628)
include_if_use(driver_lpc_adc.LPC54628)
include_if_use(driver_lpc_crc.LPC54628)
include_if_use(driver_lpc_dma.LPC54628)
include_if_use(driver_lpc_enet.LPC54628)
include_if_use(driver_lpc_gpio.LPC54628)
include_if_use(driver_lpc_iocon.LPC54628)
include_if_use(driver_lpc_lcdc.LPC54628)
include_if_use(driver_lpc_rtc.LPC54628)
include_if_use(driver_mcan.LPC54628)
include_if_use(driver_mma8451q.LPC54628)
include_if_use(driver_mma8652fc.LPC54628)
include_if_use(driver_mrt.LPC54628)
include_if_use(driver_mx25r_flash.LPC54628)
include_if_use(driver_otp.LPC54628)
include_if_use(driver_pf1550.LPC54628)
include_if_use(driver_pf3000.LPC54628)
include_if_use(driver_phy-common.LPC54628)
include_if_use(driver_phy-device-lan8720a.LPC54628)
include_if_use(driver_pint.LPC54628)
include_if_use(driver_power.LPC54628)
include_if_use(driver_reset.LPC54628)
include_if_use(driver_rit.LPC54628)
include_if_use(driver_rng.LPC54628)
include_if_use(driver_rtt.LPC54628)
include_if_use(driver_rtt_template.LPC54628)
include_if_use(driver_sctimer.LPC54628)
include_if_use(driver_sdif.LPC54628)
include_if_use(driver_sgtl5000.LPC54628)
include_if_use(driver_sha.LPC54628)
include_if_use(driver_spifi.LPC54628)
include_if_use(driver_spifi_dma.LPC54628)
include_if_use(driver_utick.LPC54628)
include_if_use(driver_video-common.LPC54628)
include_if_use(driver_wm8904.LPC54628)
include_if_use(driver_wm8960.LPC54628)
include_if_use(driver_wwdt.LPC54628)
...
include_if_use(middleware_baremetal.LPC54628)
...
include_if_use(middleware_sdmmc_host_sdif_freertos)
include_if_use(middleware_sdmmc_host_sdif_interrupt)
include_if_use(middleware_sdmmc_host_sdif_polling)
...
include_if_use(utilities_misc_utilities.LPC54628)
include_if_use(utility_assert.LPC54628)
include_if_use(utility_assert_lite.LPC54628)
include_if_use(utility_debug_console.LPC54628)
include_if_use(utility_debug_console_lite.LPC54628)
include_if_use(utility_notifier.LPC54628)
include_if_use(utility_shell.LPC54628)
include_if_use(utility_str.LPC54628)
